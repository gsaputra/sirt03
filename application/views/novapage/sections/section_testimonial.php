...
<div id="<?php echo $item ;?>" class="section section-testimonial"
<?php 
        $skema_warna = 'default';
        switch ($section_testimonial['skema_warna']) {
            case 'image':
                $skema_warna = 'bg-image';
                ?>
                style="background:url('<?php echo base_url('asset/img_novapage/images/'.$section_testimonial['background']);?>');
                                    ...
                                    <div class="carousel-testimoni-inner" role="listbox">
                                        ...
                                        <div class="carousel-item <?php echo ($i == 0 ? 'active': '');?>">
                                            <div class="photo-testimoni">
                                                <img src="<?php echo base_url();?>asset/img_novapage/testimoni/<?php echo $testi['photo'];?>" alt="<?php echo $testi['nama'];?>">
                                            </div>                                    
