...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <?php 
            if($this->uri->segment(2)!='home' AND $this->uri->segment(2)!=''){
              ...
              echo "<li class='breadcrumb-item'>Haloo, Selamat Datang</li>";
            }
          ?>
          </ol>
          </div><!-- /.col -->
  ...
  <footer class="main-footer text-sm">
    <strong>Copyright &copy; 2020-<?php echo date('Y'); ?> <a target='_BLANK' href="https://gsaputra.github.io/"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.
