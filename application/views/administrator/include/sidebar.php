    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-header">MAIN MENU</li>
           ...
           */
          ?>
          <li class="nav-item has-treeview module-novapage">
            <a href="#" class="nav-link">
            <i class="nav-icon fas fa-cogs"></i>
            <p>Modul Novapage <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
            <?php       
              //mod novapage testimoni
              $cek=$this->model_app->umenu_akses("novapage-testimoni",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item novapage-testimoni'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-testimoni'><i class='far fa-circle nav-icon text-success'></i> <p>Novapage Testimoni</p></a></li>";
              } 
              //modnovapage client 
              $cek=$this->model_app->umenu_akses("novapage-client",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item novapage-client'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-client'><i class='far fa-circle nav-icon text-success'></i> <p>Novapage Client</p></a></li>";
              } 
              //modnovapage team 
              $cek=$this->model_app->umenu_akses("novapage-team",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item novapage-team'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-team'><i class='far fa-circle nav-icon text-success'></i> <p>Novapage Team</p></a></li>";
              }        
              //modnovapage portfolio
              $cek=$this->model_app->umenu_akses("novapage-portfolio",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item novapage-portfolio'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-portfolio'><i class='far fa-circle nav-icon text-success'></i> <p>Novapage Portfolio</p></a></li>";
              }     
              //mod novapage images
              $cek=$this->model_app->umenu_akses("novapage-images",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item novapage-images'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-images'><i class='far fa-circle nav-icon text-success'></i> <p>Novapage Images</p></a></li>";
              }  
              //mod novapage
              $cek=$this->model_app->umenu_akses("novapage",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item novapage'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage'><i class='far fa-circle nav-icon text-success'></i> <p>Novapage Panel</p></a></li>";
              }  
